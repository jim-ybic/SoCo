...
public class CreateTaskOnServerJob extends AsyncTask<Void, Void, Boolean>{
    ...
    String getUrl(){
        ...
        String path = com.soco.SoCoClient.common.http.Config.SERVER_PATH_CREATE_TASK;
    ...
    JSONObject getJsonData(){
        ...
        try{
            data.put(com.soco.SoCoClient.common.http.Config.JSON_KEY_NAME, task.getTaskName());
            data.put(com.soco.SoCoClient.common.http.Config.JSON_KEY_SIGNATURE, com.soco.SoCoClient.common.database.Config.ENTITY_VALUE_EMPTY);
            data.put(com.soco.SoCoClient.common.http.Config.JSON_KEY_TYPE, com.soco.SoCoClient.common.database.Config.ENTITY_VALUE_EMPTY);
            data.put(com.soco.SoCoClient.common.http.Config.JSON_KEY_TAG, com.soco.SoCoClient.common.database.Config.ENTITY_VALUE_EMPTY);
        }catch(Exception e){
    ...
    boolean parse(Object response){
        ...
        try {
            ...
            if(isSuccess.equals(com.soco.SoCoClient.common.http.Config.JSON_VALUE_SUCCESS)){
                int tidServer = Integer.parseInt(data.getString(com.soco.SoCoClient.common.http.Config.JSON_KEY_ID));
                task.refresh();
