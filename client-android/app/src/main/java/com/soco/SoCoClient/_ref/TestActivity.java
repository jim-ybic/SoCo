...
import com.soco.SoCoClient.common.http.Heartbeat;
import com.soco.SoCoClient.common.http.task.SendMessageJob;
...
public class TestActivity extends ActionBarActivity {
    ...
    public void jim(View view){
        ...
        editor.putString(com.soco.SoCoClient.common.http.Config.PROFILE_LOGIN_ACCESS_TOKEN, "49bugba6gfkoqpc2fho92tc4ajfi7aaj");
        editor.commit();
    ...
    public void voljin(View view){
        ...
        editor.putString(com.soco.SoCoClient.common.http.Config.PROFILE_LOGIN_ACCESS_TOKEN, "mrqq9v1e4901vn065vfufep1f9iu9ejk");
        editor.commit();
    ...
    public void test2 (View view){
        ...
        Attribute attr1 = new Attribute(context, com.soco.SoCoClient.common.database.Config.ACTIVITY_TYPE_TASK,
                task.getTaskIdLocal(), task.getTaskIdServer());
        attr1.setAttrName(com.soco.SoCoClient.common.database.Config.ATTRIBUTE_NAME_DATE);
        ...
        Attribute attr2 = new Attribute(context, com.soco.SoCoClient.common.database.Config.ACTIVITY_TYPE_TASK,
                task.getTaskIdLocal(), task.getTaskIdServer());
        attr2.setAttrName(com.soco.SoCoClient.common.database.Config.ATTRIBUTE_NAME_LOCATION);
        attr2.setAttrValue("hk");
        attr2.save();

        Attribute attr3 = new Attribute(context, com.soco.SoCoClient.common.database.Config.ACTIVITY_TYPE_TASK,
                task.getTaskIdLocal(), task.getTaskIdServer());
        attr3.setAttrName(com.soco.SoCoClient.common.database.Config.ATTRIBUTE_NAME_DESCRIPTION);
    ...
    public void test3(View view){
        ...
        editor.putString(com.soco.SoCoClient.common.http.Config.PROFILE_SERVER_IP, "192.168.0.100");
        editor.putString(com.soco.SoCoClient.common.http.Config.PROFILE_SERVER_PORT, "8080");
        editor.putString(com.soco.SoCoClient.common.http.Config.PROFILE_LOGIN_ACCESS_TOKEN, "49bugba6gfkoqpc2fho92tc4ajfi7aaj");
        editor.commit();
