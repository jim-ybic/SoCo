...
//        profile = socoApp.profile;
    ...
    public Object request(String url,
        ...
        try {
            data.put(HttpConfig.JSON_KEY_PROJECT, aid_onserver);
            data.put(HttpConfig.JSON_KEY_FILE_NAME, displayName);
            data.put(HttpConfig.JSON_KEY_URI, uri);
            data.put(HttpConfig.JSON_KEY_REMOTE_PATH, remotePath);
            data.put(HttpConfig.JSON_KEY_LOCAL_PATH, localPath);
            data.put(HttpConfig.JSON_KEY_USER, user);
