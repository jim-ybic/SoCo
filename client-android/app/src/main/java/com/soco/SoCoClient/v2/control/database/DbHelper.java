...
public class DbHelper extends SQLiteOpenHelper {
        ...
        public static String DATABASE_NAME = "socodb.v2.21";
        ...
        public void onCreate(SQLiteDatabase db) {
                ...
                db.execSQL("CREATE TABLE IF NOT EXISTS " + DataConfig.TABLE_SINGLE_CONVERSATION + " ("
                        + DataConfig.COLUMN_SINGLE_CONVERSATION_SEQ + " INTEGER PRIMARY KEY AUTOINCREMENT"
                        + ", " + DataConfig.COLUMN_SINGLE_CONVERSATION_ID + " INTEGER"
                        + ", " + DataConfig.COLUMN_SINGLE_CONVERSATION_TITLE + " VARCHAR"
                        + ", " + DataConfig.COLUMN_SINGLE_CONVERSATION_LASTMSGCONTENT + " VARCHAR"
                        + ", " + DataConfig.COLUMN_SINGLE_CONVERSATION_LASTMSGTIMESTAMP + " VARCHAR"
                        + ", " + DataConfig.COLUMN_SINGLE_CONVERSATION_CREATEDBYUSERID + " INTEGER"
                        + ", " + DataConfig.COLUMN_SINGLE_CONVERSATION_CREATEDTIMESTAMP + " VARCHAR"
                        + ", " + DataConfig.COLUMN_SINGLE_CONVERSATION_COUNTERPARTYID + " INT"
                        + ", " + DataConfig.COLUMN_SINGLE_CONVERSATION_COUNTERPARTYNAME + " VARCHAR"
                        + ")");
