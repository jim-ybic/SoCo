...
public class ProjectLocationActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lat = findAttrValue(attrMap, DataConfig.ATTRIBUTE_NAME_LOCLAT);
        if(lat.isEmpty())
            lat = DataConfig.DEFAULT_LOCATION_LAT;
        lng = findAttrValue(attrMap, DataConfig.ATTRIBUTE_NAME_LOCLNG);
        if(lng.isEmpty())
            lng = DataConfig.DEFAULT_LOCATION_LNG;
        zoom = findAttrValue(attrMap, DataConfig.ATTRIBUTE_NAME_LOCZOOM);
        if(zoom.isEmpty())
            zoom = DataConfig.DEFAULT_LOCATION_ZOOM;
        ...
        ((EditText)findViewById(R.id.tv_splocname)).setText(name, TextView.BufferType.EDITABLE);
    }
    ...
    public void reset(View view){
        ...
        googleMap.clear();
        ((EditText)findViewById(R.id.tv_splocname)).setText("", TextView.BufferType.EDITABLE);
    }
    ...
    public void save(View view){
        ...
        app.lng = lng;
        app.zoom = zoom;
        String name = ((EditText)findViewById(R.id.tv_splocname)).getText().toString();
