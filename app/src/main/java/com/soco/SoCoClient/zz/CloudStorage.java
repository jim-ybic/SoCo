...
//        Log.i("cloud", "Get properties");
//        System.out.println(new CloudStorage().getClass().getResource("cloudstorage.properties"));
//        System.out.println(new CloudStorage().getClass().getResource("cloudstorage.properties"));
//        System.out.println(new CloudStorage().getClass().getClassLoader().getResource("cloudstorage.properties"));
//
//
//        if (properties == null) {
...
////                InputStream stream = new FileInputStream("cloudstorage.properties");
...
//        }
//
//        properties.setProperty(ACCOUNT_ID_PROPERTY, "jim.ybic@gmail.com");
//        properties.setProperty(PRIVATE_KEY_PATH_PROPERTY, "keystore-soco.jks");
//        properties.setProperty(APPLICATION_NAME_PROPERTY, "SoCo");
//        properties.setProperty(PROJECT_ID_PROPERTY, "soco-platform");
//
//        Log.i("cloud", "Properties loaded: " + properties.toString());
//        return properties;
//    }
//
//    private static Storage getStorage() throws Exception {
//        Log.i("cloud", "Get storage");
//
//        if (storage == null) {
//
